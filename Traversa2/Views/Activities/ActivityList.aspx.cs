...
namespace Traversa2.Views.Activities
{
    public partial class ActivityList : System.Web.UI.Page
    {
        ...
        protected void DataListActivity_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "FindOutMore")
            {
                Label tempLbl = (Label)e.Item.FindControl("lblAcId");
                Session["ActId"] = tempLbl.Text;
                Response.Redirect("ViewActivity.aspx");
            }
        }
    }
