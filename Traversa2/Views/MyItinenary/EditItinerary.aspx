<%@ Page Title="" Language="C#" MasterPageFile="~/navbarAfterLogin.Master" AutoEventWireup="true" CodeBehind="EditItinerary.aspx.cs" Inherits="Traversa2.Views.MyItinenary.EditItinerary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
     ...
     <div class="container ice">
        <div class="card hot">
            <div class="card-title text-center  T">Edit Itinerary</div>
            <div class="card-body">
                <form class="text-center">
                    ...
                    <div class="text-center col-sm-5 col-md-5 col-lg-6 f">
                        <asp:Button ID="btnUpdate" class="btn btn-success btn-round btn-lg btn-block" runat="server" Text="Update" OnClick="btnUpdate_Click"/>
                    </div>
                </form>
            </div>
        </div>
